...
//     try {
//       // Determine target user: mention, ID, or default to message author
//       const targetMember =
//         message.mentions.members.first() ||
//         message.guild.members.cache.get(args[0]) ||
//         message.member;

//       // Retrieve the target user's level data for this guild
...
//           content: `${targetMember.user.tag} has no recorded level data.`,
//         });
//       }

//       // Retrieve all level data for the guild, sorted descending by xp
//       const allData = await levelModel
...
//       const rank =
//         allData.findIndex((data) => data.user === targetMember.id) + 1;

//       // Create an embed with rank, level, and XP information
//       const embed = new EmbedBuilder()
//         .setTitle(`${targetMember.user.username}'s Rank`)
//         .setThumbnail(
//           targetMember.user.displayAvatarURL({ dynamic: true, size: 512 })
//         )
//         .setColor("Random")
//         .addFields(
//           { name: "Level", value: `${userData.level}`, inline: true },
//           { name: "XP", value: `${userData.xp}`, inline: true },
//           { name: "Rank Position", value: `#${rank}`, inline: true }
//         )
...
//       return message.channel.send({
//         content: "An error occurred while retrieving rank data.",
//       });
//     }
//   },
// };
